//to allocate appropriate access specifiers to data members of studentand course class
//to add details of a student using parameterized constructor of student class
#include <iostream>
using namespace std;
class student
...
int main()
{
    student s("Shrutam", 3, 4, 5, 6);
    student s1("Aditya", 5, 6, 4, 4);
    s.print();
    s.avg();
    s1.print();
    s1.avg();
